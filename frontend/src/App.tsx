...
function App() {
  ...
  return (
    <div className="h-screen w-full bg-slate-200/50 flex items-center justify-centre overflow-hidden">
      <div className="flex h-screen lg:h-[100vh] w-full lg:w-[100%] overflow-hidden bg-white shadow-2xl lg:rounded-none border border-slate-200/60">
        {/* Sidebar - Desktop */}
